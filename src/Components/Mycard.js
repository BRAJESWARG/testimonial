...
const Mycard = (props) => {
    return (
        <div className='mycard'>
            ...
            <div className="card">
                <img className="product--image" src="http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcR2OIBC4ai6__woXzFywGOaYTS0dOvQx0PoIHB5BLVnz2CO0sMjZ5s7YgKQzuc_b5sTQxxaI8sTWzWjCYs" alt="product" width="100px" />
                <h2>Sir Ratan Tata</h2>
                <h5>Industrialist and former chairman of Tata Sons.</h5>
                <p className="description">Ratan Naval Tata is an Indian Industrialist and former chairman of Tata Sons. He was also the chairman of the Tata Group from 1990 to 2012.</p>
